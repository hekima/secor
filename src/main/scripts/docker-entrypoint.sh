...
# based on https://github.com/ovotech/docker-secor
...
SECOR_CONFIG_FILE=/opt/secor/secor.kubernetes-prod.properties
LOG4J_CONFIG_FILE=/opt/secor/log4j.kubernetes-prod.properties
...
java -Xmx${JVM_MEMORY:-512m} -ea \
  ...
  -Dconfig=$SECOR_CONFIG_FILE \
  -cp /opt/secor/secor.jar:/opt/secor/lib/* \
